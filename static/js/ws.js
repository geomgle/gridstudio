          ...
          if (lines[x].length > 0) {
            ...
            if (json[0] == "SET") {
              ...
              if (consoleText.indexOf("[error]") != -1) {
                ...
                _this.app.console.append(
                  "<div class='message error'>" + consoleText + "</div>",
                );
              } else {
                _this.app.console.append(
                  "<div class='message'>" + consoleText + "</div>",
                );
              }
              _this.app.console[0].scrollTop =
                _this.app.console[0].scrollHeight;
              ...
              if (maxLength != 0) {
                measuredWidth =
                  _this.app.computeCellTextSize(
                    _this.app.get(cell, sheetIndex),
                  ) +
                  _this.app.textPadding * 2;
              ...
              _this.app.testManager.currentTestCallback.apply(
                _this.app.testManager,
              );
            } else {
