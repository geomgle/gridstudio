(function () {
  function FileManager(app) {
    ...
    this.init = function () {
      this.base_cwd =
        "/home/userdata/workspace-" + this.app.slug + "/userfolder";
      ...
      this.app.wsManager.send({
        arguments: ["GET-FILE", this.base_cwd + "/main.py"],
      });
    };
    ...
    this.showDirectory = function (data) {
      ...
      for (var x = 0; x < data.length; x += 3) {
        ...
        var icon =
          '<div class="icon" style="background-image: url(\'image/file-icons/folder.svg\')"></div>';
